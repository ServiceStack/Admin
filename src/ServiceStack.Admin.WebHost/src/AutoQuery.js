...
System.register(['react', './Header', './Sidebar', './Content', './ColumnPrefsDialog', 'jquery', 'ss-utils'], function(exports_1, context_1) {
    "use strict";
