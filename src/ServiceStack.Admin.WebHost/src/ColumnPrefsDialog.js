        ...
        execute: function() {
            ColumnPrefsDialog = (function (_super) {
                ...
                ColumnPrefsDialog.prototype.render = function () {
                    ...
                    }}, React.createElement("i", {"className": "material-icons", "style": CheckboxStyle}, fields.length === 0 ? 'radio_button_checked' : 'radio_button_unchecked'), React.createElement("span", null, "Show all columns")), this.props.type.properties.map(function (p) { return (React.createElement("div", {"onClick": function (e) { return _this.selectField(p.name); }, "style": { margin: '0 0 5px 0', cursor: 'pointer' }}, React.createElement("i", {"className": "material-icons", "style": CheckboxStyle}, fields.indexOf(p.name) >= 0 ? 'check_box' : 'check_box_outline_blank'), React.createElement("span", null, p.name))); })), React.createElement("div", {"className": "dialog-footer", "style": { textAlign: 'right' }}, React.createElement("div", {"className": "btnText", "onClick": function (e) { return _this.props.onClose(); }}, React.createElement("span", null, "DONE")))))));
                };
